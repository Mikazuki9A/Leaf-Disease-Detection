...
title = tk.Label(text="Click below to choose picture for testing disease....", background = "blue", fg="Brown", font=("", 15))
title.grid()
def bact():
    window.destroy()
    window1 = tk.Tk()
    ...
    remedies = tk.Label(text=rem, background="blue",
                      fg="Brown", font=("", 15))
    ...
    remedies1 = tk.Label(text=rem1, background="blue",
                        fg="White", font=("", 12))
...
def vir():
    ...
    window1.title("Leaf Disease prediction")
...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        message = tk.Label(text='Status: '+status, background="blue",
                           fg="Brown", font=("", 15))
        message.grid(column=0, row=3, padx=10, pady=10)
        if str_label == 'bacterial':
            diseasename = "Bacterial Spot "
            disease = tk.Label(text='Disease Name: ' + diseasename, background="blue",
                               fg="White", font=("", 15))
            disease.grid(column=0, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="blue", fg="Brown", font=("", 15))
            ...
            r = tk.Label(text='Plant is healthy', background="blue", fg="White",
                         font=("", 15))
...
def openphoto():
    ...
    dst = "D:/Technosoft Project(Leaf Disease Detection)/testpicture/"
